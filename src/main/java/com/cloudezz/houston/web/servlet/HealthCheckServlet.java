...
public class HealthCheckServlet extends com.codahale.metrics.servlets.HealthCheckServlet {
  ...
  private static final long serialVersionUID = 5261405701328494624L;
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    // Overrides the default behaviour. We don't want to return 500 Internal Service Error if one or
    // more fail.
    // This count has an error 500, which is not the case.
    //
    // HealthCheckServlet responds to GET requests by running all the [health

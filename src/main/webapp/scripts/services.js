...
houstonApp.factory('Account', [ '$resource', function($resource) {
		...
		function($resource, $http) {
			return {
				...
				changePwd : function(password, callback) {
					$http.post('app/rest/account/change_password', password)
				...
				setPwd : function(id, password, callback) {
					$http.post('app/rest/account/set_password/' + id, password)
							.success(function(data, status) {
								callback(data, status);
							}).error(function(data, status) {
								callback(data, status);
...
houstonApp.factory('Sessions', [ '$resource', function($resource) {
...
houstonApp.factory('Metrics', [ '$resource', function($resource) {
...
houstonApp.factory('HealthCheckService', [
		'$rootScope',
		'$http',
		function($rootScope, $http) {
			return {
				check : function() {
					var promise = $http.get('metrics/healthcheck').then(
							function(response) {
...
houstonApp.factory('LogsService', [ '$resource', function($resource) {
...
houstonApp.factory('SignUpService', [ '$http', function($http) {
	return {
...
houstonApp.factory('AuditsService', [
		'$http',
		function($http) {
			return {
				findAll : function() {
...
houstonApp.factory('ImageInfo', [ '$resource', function($resource) {
...
houstonApp.factory('AppImageService', [
		'$http',
		function($http) {
			return {
				...
				loadForm : function(id) {
					var form = $http.get('app/rest/imageInfos/form/' + id)
							.then(function(response) {
								return response.data;
							});
					return form;
